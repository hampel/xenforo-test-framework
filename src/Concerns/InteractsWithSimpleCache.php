...
trait InteractsWithSimpleCache
{
	...
	public function assertSimpleCacheHas($addOnId, $key)
	{
		PHPUnit::assertTrue(
	...
	public function assertSimpleCacheEqual($expected, $addOnId, $key)
	{
	...
	public function assertSimpleCacheNotEqual($expected, $addOnId, $key)
	{
